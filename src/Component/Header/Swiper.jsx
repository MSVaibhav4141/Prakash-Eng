...
const SwiperImported = () => {
  ...
  useEffect(() => {
    if (headingCont.current) {
      const headingcont = Array.from(
        headingCont.current.querySelectorAll("span")
      );
      headingRef.current = headingcont;
    }
    if (bouncyButtonCont.current) {
      const bouncybutton = Array.from(
        bouncyButtonCont.current.querySelectorAll("button")
      );
  ...
  return (
    <>
      ...
      >
        <Box
          sx={{ opacity: 1, display: "flex", alignItems: "center", flex: 1 }}
        >
          <Box
            sx={{
              height: "70px",
      ...
      >
        ...
        <Box
          sx={{
            ...
            zIndex: 100,
            top: { xs: "40%", md: "40%" },
            left: { xs: "2vmax", md: "13vmax" },
            transform: { xs: "translateY(-40%)" },
            md: "translateY(-40%)",
            display: "flex",
        ...
        >
          <Box
            sx={{
              ...
              display: "flex",
              alignItems: "center",
              color: { xs: "#fdfdfd", md: "rgb(88 88 88)" },
            }}
          >
        ...
        >
          <BouncyButton
            onClick={() => mainSwiper.slideTo(currentIndex - 1)}
            value={<ArrowBackIosIcon />}
            looseBorder={true}
            styles={{
              width: "30px",
              height: "30px",
